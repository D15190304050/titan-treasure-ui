...
const EditAddress: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (id === '1') {
        ...
        form.setFieldsValue(mockAddress);
        setSelectedProvince(mockAddress.province);
        setSelectedCity(mockAddress.city);
      }
      setLoading(false);
    }, 1000);
  }, [id, form]);
  ...
  if (!address) {
    return (
      <Card>
        <Typography.Text>无法加载地址信息</Typography.Text>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <Card>
        <Title level={3} className="mb-6">编辑收货地址</Title>
        <Form
          form={form}
          name="edit_address"
          onFinish={onFinish}
